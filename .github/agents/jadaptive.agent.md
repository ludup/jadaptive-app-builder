...
- Prefer `@PageMenu` on the entity (or page/controller) to surface it in the navigation; only create a standalone `ApplicationMenu` when `@Pag
	private String identifier;

	public IpLease() {
	}

	public IpLease(C ipAddress, Instant leased, Duration eMenu` cannot cover the use case.
