...
- Dependencies are isolated per plugin classloader. Exclude common transitive libs like SLF4J and Jackson if pulled by your dependencies to avoid conflicts with the host.
