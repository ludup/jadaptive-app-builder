...
Vue.component('entity-table', {
	  ...
	  mounted: function() {
		  ...
		  $('.jedit').on('click', function(e) {
			  ...
			  debugger;
			  window.location = '/app/vue/entity#template=' + _props.page.template.uuid + '&uuid=' + uuid;
		  });
	  },
	  computed: {
		  orderedColumns: function() {
	    	  ...
	    	  columns.push({
	    		  ...
	    		  formatter: function(val, row, idx) {
	    			  return '<a class="jedit" data-uuid="' + row.uuid + '" href="#"><i class="far fa-edit"></i></a>';
	    		  }
	    	  });
	    	  return columns;
		  },
	  ...
	  computed: {
          orderedFields () {
	    	  ...
	    	  if(this._props.template.fields) {
	    		  $.each(this._props.template.fields, function(idx, obj) {
	    			  if(obj.fieldType === 'OBJECT_EMBEDDED' || obj.fieldType === 'OBJECT_REFERENCE') {
	    				  return;
	    			  }
	    			  tmp.push(obj);
	    		  });
	    		  ...
	    		  /**
	    		   * TODO: sort from some UI meta-data.
	    		   */
//		    	  tmp.sort(function(a, b){return a.weight - b.weight});
	    	  }
	    	  return tmp;
...
//		    	  tmp.sort(function(a, b){return a.weight - b.weight});
	  ...
	  template: `
	    <form>
	        ...
	        <div v-if="orderedObjects.length > 0">
	          <ul class="nav nav-tabs" role="tablist">
	             <li class="nav-item" v-for="(category, index) in orderedObjects">
              ...
              <div class="tab-content">
                 <template v-for="(category, index) in orderedObjects">
