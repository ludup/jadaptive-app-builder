...
public class WebbitsComponentScanRegistrar implements ImportBeanDefinitionRegistrar {

    private static final String BEAN_NAME = "webbitsComponentRegisteringPostProcessor";
	...
	beanDefinition.setBeanClass(WebbitsPostProcessor.class);
	...
	AnnotationAttributes attributes = AnnotationAttributes
		.fromMap(metadata.getAnnotationAttributes(WebbitsComponentScan.class.getName()));
