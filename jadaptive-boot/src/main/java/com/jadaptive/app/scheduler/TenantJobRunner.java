...
public class TenantJobRunner implements Runnable {
	...
	public void run() {
		 ...
		 */
		if(task.getScope() == TaskScope.GLOBAL && !clusterManager.isLeader()) {
			if(log.isInfoEnabled()) {
				log.info("Not executing task {} because the task is GLOBAL and this node is not the cluster leader",
