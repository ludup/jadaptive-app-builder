...
@Repository
public class SystemOnlyObjectDatabaseImpl<T extends UUIDEntity> 
		extends AbstractObjectDatabaseImpl implements SystemOnlyObjectDatabase<T> {

	public SystemOnlyObjectDatabaseImpl(DocumentDatabase db) {
		super(db);
	}
