...
public class AbstractObjectDeserializer extends StdDeserializer<AbstractObject> {
	...
	private void iterateFields(JsonNode current, Collection<FieldTemplate> fields, AbstractObject e) throws IOException, ValidationException {
...
//	}
	...
	private void processSimpleTypes(FieldTemplate field, JsonNode node, AbstractObject e) throws IOException, ValidationException {
		if(node.isArray()) {
	...
	private void setCollectionProperty(FieldTemplate field, JsonNode node, AbstractObject e) throws IOException, ValidationException {
