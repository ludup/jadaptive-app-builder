...
public class EnableMessage extends AbstractTenantAwareCommand {
	
	@Autowired
	private ApplicationService applicationService; 
	
	public EnableMessage() {
		super("enable-message", "Message Templates",
					UsageHelper.build("enable-message <shortName>"), 
					"Enable a message template");
	}
