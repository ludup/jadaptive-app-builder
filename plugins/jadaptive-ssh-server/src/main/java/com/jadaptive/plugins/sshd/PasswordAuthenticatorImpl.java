...
public class PasswordAuthenticatorImpl extends PasswordAuthenticationProvider {
	...
	static Logger log = LoggerFactory.getLogger(PasswordAuthenticatorImpl.class);
	...
	public boolean verifyPassword(SshConnection con, String username, String password)
		...
		try {
			...
			if(Log.isInfoEnabled()) {
				Log.info("{} is attempting password authentication on tenant {}",
						tenantUsername, tenantService.getCurrentTenant().getName());
			}
