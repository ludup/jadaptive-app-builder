...
import com.jadaptive.api.events.EventState;
...
@AuditedObject
@ObjectDefinition(resourceKey = AuthenticationFailedEvent.RESOURCE_KEY, scope = ObjectScope.GLOBAL, 
...
public class AuthenticationFailedEvent extends UserGeneratedEvent {
