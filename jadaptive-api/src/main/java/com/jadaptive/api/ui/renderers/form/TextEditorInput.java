...
public class TextEditorInput extends FieldInputRender {

	private Document document;

	public TextEditorInput(TemplateViewField field, Document document) {
		super(field);
		this.document = document;
	}
	
	public TextEditorInput(Document document, String resourceKey, String formVariable, String bundle) {
