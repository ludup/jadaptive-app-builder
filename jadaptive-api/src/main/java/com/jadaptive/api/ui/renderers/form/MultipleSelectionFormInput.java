		...
		rootElement.appendChild(new Element("div")
				...
				.appendChild(inputs = new Element("div")
					...
					.appendChild(new Element("div")
							...
							.addClass("col-5")
							.appendChild(Html.i18n(template.getBundle(), String.format("%s.left.text", field.getResourceKey()))
					...
					.appendChild(new Element("div")
							...
							.appendChild(new Element("a")
									...
									.appendChild(new Element("i")
											.addClass("fa-solid fa-chevron-left"))))
					.appendChild(new Element("div")
							.attr("id", String.format("%sSelected", field.getResourceKey()))
							.addClass("col-5")
							.appendChild(Html.i18n(template.getBundle(), String.format("%s.right.text", field.getResourceKey()))
								.addClass("small text-muted"))
