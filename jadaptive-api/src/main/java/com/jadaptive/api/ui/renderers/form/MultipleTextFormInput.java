...
public class MultipleTextFormInput {
	...
	public void renderInput(OrderedView panel, Element rootElement, 
		...
		rootElement.appendChild(new Element("div").addClass("form-group multipleTextInput")
				...
				.appendChild(new Element("div")
					...
					.appendChild(new Element("a")
							...
							.attr("class", "input-group-append multipleTextAdd")
				...
				.appendChild(new Element("div")
					...
					.appendChild(new Element("div")
							...
							.appendChild(selected = new Element("select")
									...
									.addClass("form-control w-100 multipleTextTarget"))))
					.appendChild(new Element("div")
							.addClass("row")
						.appendChild(new Element("div")
								.addClass("col-md-10")
						...
						.appendChild(new Element("div")
								...
								.appendChild(new Element("button")
									.addClass("btn btn-primary btn-sm multipleTextRemove")
									.attr("href", "#")
									.appendChild(new Element("i")
