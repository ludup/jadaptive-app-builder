...
@AuditedObject
@ObjectDefinition(resourceKey = LeadershipObtainedEvent.RESOURCE_KEY, scope = ObjectScope.GLOBAL, 
...
public class LeadershipObtainedEvent extends ObjectEvent<ClusterNode> {
	
	private static final long serialVersionUID = 6612104802338158304L;
	
	public static final String RESOURCE_KEY = "leadershipObtained";
	private ClusterNode object;

	public LeadershipObtainedEvent(ClusterNode object) {
		super(RESOURCE_KEY, "networks");
		this.object = object;
		setName(object.getHostname());
	}
	
	public LeadershipObtainedEvent(ClusterNode object, Throwable error) {
